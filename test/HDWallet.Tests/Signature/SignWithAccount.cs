...
namespace HDWallet.Tests.Signature
{
    public class SignWithAccount
    {
        ...
        public void Test1()
        {
            IHDWallet<Sample.BitcoinWallet> bitcoinHDWallet = new Sample.BitcoinHDWallet("conduct stadium ask orange vast impose depend assume income sail chunk tomorrow life grape dutch", "");
