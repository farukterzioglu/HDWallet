...
namespace HDWallet.Cardano.Tests
{
    public class GenerateBitcoinHDWallet
    {
        ...
        public void ShouldGenerateMasterWalletFromPurposeAndPath()
        {
            ...
            var coinTypeWallet = hdWallet.GetWalletFromPath<BitcoinWallet>("m/44'/354'/0'/0'/1'");
            var address = coinTypeWallet.GetNetworkAddress(AddressType.BitcoinLive);
        ...
        public void ShouldGenerateFromMnemonic()
        {
            ...
            var polkadotAddress = wallet.GetNetworkAddress(AddressType.BitcoinLive);
        ...
        public void ShouldGenerateKusamaFromMnemonic()
        {
            ...
            IHDWallet<BitcoinWallet> hdWallet = new KusamaHDWallet(kusamaMne,"");

            var wallet = hdWallet.GetAccount(0).GetExternalWallet(0);
            var address = wallet.Address;

            Assert.AreEqual(expected: "5EkVRZntoGaMkRS4o9hFF6EWPgLFoP4vFSicNHqL9TFF6Sow", actual: address);
            Assert.AreEqual(expected: "13gnZu3xf3qqBxSaknkFPF4fFJKuVgd4KwT6XapghYGmH365", actual: wallet.GetNetworkAddress(AddressType.BitcoinLive));
        }
        ...
        IHDWallet<BitcoinWallet> hdWallet = new BitcoinHDWallet("ba78b733ffe929e400f844751a48dded5ebc7c62635a1590e97b066e3b9e8b890741602a69279c45ed5d17dfd6e8703e3c575de4ea4712868df5f1997e2b97b2");
